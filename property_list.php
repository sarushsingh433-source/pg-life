...
<title>Best PG's in <?php echo $city_name !== '' ? htmlspecialchars($city_name, ENT_QUOTES, 'UTF-8') : 'your city' ?> | PG Life</title>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <?php echo $city_name !== '' ? htmlspecialchars($city_name, ENT_QUOTES, 'UTF-8') : 'Your city'; ?>
            </li>
        </ol>
    </nav>
